...
class myDES{
	public:
		...
		void bit_xor(const char *bits1, const char *bits2, char *bitsx, char taille);
		void bit_rot_left(char *bits, char taille, char n);
		void permute(char *bits, char *corresp, char n);

		void des(char* vect_init, char* key1, char* key2, char* texte, char* chiffre, int size, char sens, char type, char mode);
